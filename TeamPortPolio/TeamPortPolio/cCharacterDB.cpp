...
void cCharacterDB::Setup()
{
	...
	Add(new ST_Character(C_R_HUMAN, C_G_MALE, C_C_HUMAN_CAVALRY, 100.0f, 100.f, 20.0f, 4, "Character/BloodeHuman/", "b_knightman.x", "Sword_2H_Broadsword_A_03_Bone08"));
	...
	Add(new ST_Character(C_R_END, C_G_END, C_C_ARROW_ARROW, 100.0f, 100.f, 50.0f, 4, "Character/Arrow/", "arrow.x", "Sword_2H_Broadsword_A_03_Bone08"));
}
