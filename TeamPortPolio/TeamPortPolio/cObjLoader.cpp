...
LPD3DXMESH cObjLoader::LoadMesh(OUT vector<ST_PNT_VERTEX> &vecVertex, OUT vector<cMtlTex*>& vecMtlTex, IN char * szFolder, IN char * szFile)
{
...
LPD3DXMESH cObjLoader::LoadMesh(OUT vector<ST_PNT_VERTEX> &vecVertex,  OUT vector<cMtlTex*>& vecMtlTex, IN char * szFolder, IN char * szFile, bool newone)
{
	vector<D3DXVECTOR3> vecV;
	vector<D3DXVECTOR2> vecVT;
	vector<D3DXVECTOR3> vecVN;
