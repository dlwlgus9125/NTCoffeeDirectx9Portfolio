...
void cNpcDB::Setup()
{
	...
	Add(new ST_Npc(N_R_HUMAN, N_C_ORC_RESIDENT1, "obj/NPC/Orc/Stuff/", "orcmalekidgruntling.X"));
	Add(new ST_Npc(N_R_HUMAN, N_C_ORC_RESIDENT2, "obj/NPC/Orc/Stuff/", "orcmalekidgruntling.X"));
	Add(new ST_Npc(N_R_HUMAN, N_C_ORC_RESIDENT3, "obj/NPC/Orc/Stuff/", "orcmalekidgruntling.X"));
